package com.example.logviewer2;
...
public class Entry extends BaseEntry implements Parcelable {
     ...
     */
    public Entry(String x, float y, Drawable icon) {
        super(y, icon);
        this.x = x;
    }
     ...
     * @param data Spot for additional data this Entry represents.
     */
    public Entry(String x, float y, Drawable icon, Object data) {
        super(y, icon, data);
        this.x = x;
    }
    ...
    public boolean equalTo(Entry e) {
        ...
        if (e.x.compareTo(this.x) > Utils.FLOAT_EPSILON)
            return false;
